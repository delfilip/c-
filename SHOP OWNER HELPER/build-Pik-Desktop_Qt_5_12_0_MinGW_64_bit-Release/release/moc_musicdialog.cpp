...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MusicDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MusicDialog_t qt_meta_stringdata_MusicDialog = {
    {
QT_MOC_LITERAL(0, 0, 11) // "MusicDialog"
...
QT_INIT_METAOBJECT const QMetaObject MusicDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_MusicDialog.data,
    qt_meta_data_MusicDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MusicDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MusicDialog.stringdata0))
